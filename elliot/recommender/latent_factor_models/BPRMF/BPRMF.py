...
class BPRMF(RecMixin, BaseRecommenderModel):
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        # self._bias_regularization = self._regularization
        self._user_regularization = self._regularization
        self._positive_item_regularization = self._regularization
        self._negative_item_regularization = self._regularization / 10
