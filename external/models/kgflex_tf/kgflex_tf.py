...
from .kgflex_tf_model import KGFlex_TFModel
...
class KGFlex_TF(RecMixin, BaseRecommenderModel):
    r"""
    ...
    def __init__(self, data, config, params, *args, **kwargs):
        ...
        self._model = KGFlex_TFModel(self._num_users, self._num_items, factors=self._factors)
